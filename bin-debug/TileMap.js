var config = [
    ...
    { x: 1, y: 6, walkable: true, image: "Road_png" },
    { x: 2, y: 6, walkable: true, image: "Road_png" },
    { x: 3, y: 6, walkable: true, image: "Road_png" },
    { x: 4, y: 6, walkable: true, image: "Road_png" },
    { x: 5, y: 6, walkable: true, image: "Road_png" },
    { x: 6, y: 6, walkable: true, image: "Road_png" },
    { x: 7, y: 6, walkable: true, image: "Road_png" },
    { x: 8, y: 6, walkable: true, image: "Road_png" },
    { x: 9, y: 6, walkable: true, image: "Road_png" },
    { x: 0, y: 7, walkable: true, image: "Road_png" },
    { x: 1, y: 7, walkable: true, image: "Road_png" },
    { x: 2, y: 7, walkable: true, image: "Road_png" },
    { x: 3, y: 7, walkable: true, image: "Road_png" },
    { x: 4, y: 7, walkable: true, image: "Road_png" },
    { x: 5, y: 7, walkable: true, image: "Road_png" },
    { x: 6, y: 7, walkable: true, image: "Road_png" },
    { x: 7, y: 7, walkable: true, image: "Road_png" },
    { x: 8, y: 7, walkable: true, image: "Road_png" },
    { x: 9, y: 7, walkable: true, image: "Road_png" },
    { x: 0, y: 8, walkable: true, image: "Road_png" },
    { x: 1, y: 8, walkable: true, image: "Road_png" },
    { x: 2, y: 8, walkable: true, image: "Road_png" },
    { x: 3, y: 8, walkable: true, image: "Road_png" },
    { x: 4, y: 8, walkable: true, image: "Road_png" },
    { x: 5, y: 8, walkable: true, image: "Road_png" },
    { x: 6, y: 8, walkable: true, image: "Road_png" },
    { x: 7, y: 8, walkable: true, image: "Road_png" },
    { x: 8, y: 8, walkable: true, image: "Road_png" },
    { x: 9, y: 8, walkable: true, image: "Road_png" },
    { x: 0, y: 9, walkable: true, image: "Road_png" },
    { x: 1, y: 9, walkable: true, image: "Road_png" },
    { x: 2, y: 9, walkable: true, image: "Road_png" },
    { x: 3, y: 9, walkable: true, image: "Road_png" },
    { x: 4, y: 9, walkable: true, image: "Road_png" },
    { x: 5, y: 9, walkable: true, image: "Road_png" },
    ...
    { x: 0, y: 10, walkable: true, image: "Road_png" },
    { x: 1, y: 10, walkable: true, image: "Road_png" },
    { x: 2, y: 10, walkable: true, image: "Road_png" },
    { x: 3, y: 10, walkable: true, image: "Road_png" },
    { x: 4, y: 10, walkable: true, image: "Road_png" },
    { x: 5, y: 10, walkable: true, image: "Road_png" },
    { x: 6, y: 10, walkable: true, image: "Road_png" },
    { x: 7, y: 10, walkable: true, image: "Road_png" },
    { x: 8, y: 10, walkable: true, image: "Road_png" },
    { x: 9, y: 10, walkable: true, image: "Road_png" }
];
